...
def train():
	...
	#Defined in utils.py
	train_gen = utils.DataIterator(img_dir=args["train_dir"], batch_size = batch_size, IMG_SIZE = [94, 24], CH_NUM = 3)
	val_gen = utils.DataIterator(img_dir=args["val_dir"],batch_size = val_batch_size, IMG_SIZE = [94, 24], CH_NUM = 3)
