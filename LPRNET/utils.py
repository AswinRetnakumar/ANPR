...
class DataIterator:
    def __init__(self, img_dir, batch_size, IMG_SIZE = [94, 24], CH_NUM = 3,runtime_generate=False):
    ...
    def init(self):
        ...
        #loop thru all files and save the filename as label, ecoded by position number
        for filename in fs:
